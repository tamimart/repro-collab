...
1. Participants sit at a comfortable viewing distance from the computer monitor
2. On each trial:
...
3. Trial distribution:
   ...
   - 100 trials for the largest differences (easiest discriminations)
   - Total: approximately 658 trials per participant
...
1. Calculate average discrimination times for each stimulus difference
